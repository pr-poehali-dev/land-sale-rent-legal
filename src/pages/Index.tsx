...
const SERVICES = [
  {
    number: "01",
    title: "Консультация по покупке участка",
    desc: "Разъясним все нюансы приобретения земельного участка: категории земель, виды разрешённого использования, порядок оформления сделки.",
  },
  {
    number: "02",
    title: "Помощь с арендой участка",
    desc: "Сопроводим процесс аренды земельного участка: подбор условий, проверка договора аренды, защита ваших интересов на каждом этапе.",
  },
  {
    number: "03",
    title: "Помощь в выборе участка",
    desc: "Поможем подобрать земельный участок под ваши цели с учётом назначения, местоположения, юридического статуса и бюджета.",
  },
  {
    number: "04",
    title: "Юридическое сопровождение",
    desc: "Полное юридическое сопровождение сделок с землёй: проверка документов, подготовка договоров, регистрация права собственности.",
  },
];
        ...
        {active === "services" && (
          <div className="max-w-6xl mx-auto px-6 py-20">
            <div className="mb-16 border-b border-border pb-12">
              ...
              <h1 className="font-cormorant text-5xl md:text-6xl font-light mb-6">Наши услуги</h1>
              <p className="text-muted-foreground max-w-2xl leading-relaxed">
                Помогаем частным лицам и бизнесу в вопросах покупки, аренды и оформления земельных участков.
